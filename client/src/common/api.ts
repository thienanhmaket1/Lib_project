...
export const allAPI = {
    ...
    office_admin_manage_folders_get_child_folders: `${apiURL}/folders/manage-folders/get-child-folders`,
    office_admin_manage_folders_get_higher_folders: `${apiURL}/folders/manage-folders/get-higher-folders`,
    office_admin_manage_folders_get_folder_detail: `${apiURL}/folders/manage-folders/get-folder-detail`,
    office_admin_manage_folders_create_folder: `${apiURL}/folders/manage-folders/create-folder`,
    office_admin_manage_higher_folders_create_folder: `${apiURL}/folders/manage-folders/create-higher-folder`,
    office_admin_manage_folders_update_folder: `${apiURL}/folders/manage-folders/update-folder`,
    office_admin_manage_higher_folders_update_folder: `${apiURL}/folders/manage-folders/update-higher-folder`,
    office_admin_manage_folders_delete_folder: `${apiURL}/folders/manage-folders/delete-folder`,
    // office_admin_manage_higher_folders_delete_folder: `${apiURL}/folders/manage-folders/delete-higher-folder`,
